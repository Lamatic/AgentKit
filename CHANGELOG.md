...
- **GX-4 — Automated Log Retrieval & Lamatic Pipeline Integration**: In-memory `.zip` decompression (`fflate`), secret redaction, ANSI stripping, and 10-node Lamatic AI execution.
