    ...
    <section className="rounded-[10px] border border-hairline bg-card p-6 transition-all">
      ...
      <div className="relative mb-3">
        <textarea
          ...
          className="w-full resize-none rounded-[6px] border border-hairline bg-[#FAFAF8] p-3 text-[14px] text-neutral-900 transition-all placeholder:text-neutral-400 focus:border-indigo-500 focus:bg-white focus:outline-none"
        />
      </div>
