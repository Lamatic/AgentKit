...
export const meta = {
  ...
  testInput: {
    approvedTask: { id: "TASK-1", title: "Implement password reset", requirementIds: ["REQ-001"] },
    requirements: [{ id: "REQ-001", description: "Users must reset forgotten passwords.", documentId: "DOC-1" }],
    documents: [{ id: "DOC-1", name: "Demo PRD", url: "https://example.test/demo-prd" }]
  }
};
export const inputs = {};
