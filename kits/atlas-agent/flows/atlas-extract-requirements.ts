...
export const meta = {
  ...
  testInput: { documentName: "Demo PRD", documentText: "# Authentication\nUsers must be able to reset a forgotten password." }
};

export const inputs = {
  InstructorLLMNode_1: [{
    name: "generativeModelName", label: "Generative Model Name", type: "model", mode: "instructor",
    modelType: "generator/text", description: "Model used for structured requirement extraction.", required: true,
    isPrivate: true, defaultValue: [{ configName: "configA", type: "generator/text", provider_name: "", credential_name: "", params: {} }],
...
export const nodes = [
  ...
  { id: "InstructorLLMNode_1", type: "dynamicNode", position: { x: 0, y: 150 }, data: { nodeId: "InstructorLLMNode", values: {
    ...
    prompts: [{ id: "extract-system", role: "system", content: "@prompts/atlas-extract-requirements_extract_system.md" }, { id: "extract-user", role: "user", content: "@prompts/atlas-extract-requirements_extract_user.md" }],
