...
export const meta = {
  ...
  tags: ["assignment", "explainability"],
  testInput: {
    task: { id: "TASK-1", title: "Implement password reset API", priority: "HIGH", complexity: "COMPLEX", requiredSkills: ["python", "api"] },
    members: [
      { memberId: "M-1", name: "Arun", role: "TEAM_LEAD", skills: ["python", "api"], currentOpenTasks: 2, currentHighPriorityTasks: 0 },
      { memberId: "M-2", name: "Nila", role: "INTERN", skills: ["api"], currentOpenTasks: 1, currentHighPriorityTasks: 0 }
    ]
  }
};
export const inputs = {
  LLMNode_1: [{ name: "generativeModelName", label: "Generative Model Name", type: "model", mode: "chat", modelType: "generator/text", description: "Model used only to explain the deterministic scorecard.", required: true, isPrivate: true, defaultValue: [{ configName: "configA", type: "generator/text", provider_name: "", credential_name: "", params: {} }], typeOptions: { loadOptionsMethod: "listModels" } }]
};
export const references = {
  constitutions: { default: "@constitutions/default.md" },
  prompts: { system: "@prompts/atlas-recommend-assignment_explain_system.md", user: "@prompts/atlas-recommend-assignment_explain_user.md" },
...
export const nodes = [
  ...
  { id: "LLMNode_1", type: "dynamicNode", position: { x: 0, y: 280 }, data: { nodeId: "LLMNode", values: {
    id: "LLMNode_1", nodeName: "Explain Recommendation", tools: [],
    prompts: [{ id: "explain-system", role: "system", content: "@prompts/atlas-recommend-assignment_explain_system.md" }, { id: "explain-user", role: "user", content: "@prompts/atlas-recommend-assignment_explain_user.md" }],
