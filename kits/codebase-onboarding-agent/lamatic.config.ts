export default {
  ...
  links: {
    ...
    deploy:
      "https://vercel.com/new/clone?repository-url=https://github.com/Lamatic/AgentKit&root-directory=kits%2Fcodebase-onboarding-agent%2Fapps&env=LAMATIC_PROJECT_API_KEY,LAMATIC_API_URL,LAMATIC_PROJECT_ID,LAMATIC_FLOW_ID&envDescription=Your%20Lamatic%20project%20keys%20are%20required."
  }
};
