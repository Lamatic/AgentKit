export default {
  ...
  description: "A production-grade AI content blocker used for Productivity purposes. Features a Next.js backend for secure Lamatic API communication and a Chrome Extension frontend for real-time contextual blocking.",
  version: '1.0.0',
  type: 'kit' as const,
  author: {"name": "Abdul Maajith"},
