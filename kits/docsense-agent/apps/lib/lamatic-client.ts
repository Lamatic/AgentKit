...
if (!process.env.DOCSENSE_INTAKE) {
  throw new Error(
    "DOCSENSE_INTAKE flow ID is not set. Please add it to your .env.local file."
  );
}
...
export const DOCSENSE_INTAKE_FLOW_ID = process.env.DOCSENSE_INTAKE;