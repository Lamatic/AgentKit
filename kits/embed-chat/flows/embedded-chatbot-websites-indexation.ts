...
// Flow: embedded-chatbot-websites-indexation

// ── Meta ──────────────────────────────────────────────
export const meta = {
  "name": "1B. Embedded Chatbot - Websites Indexation",
  "description": "",
  "tags": [],
  "testInput": {
    "urls": [
...
export const references = {
  ...
  "scripts": {
    "embedded_chatbot_websites_indexation_extract_chunks": "@scripts/embedded-chatbot-websites-indexation_extract-chunks.ts",
    "embedded_chatbot_websites_indexation_transform_metadata": "@scripts/embedded-chatbot-websites-indexation_transform-metadata.ts"
  }
};
...
export const nodes = [
  ...
  },
  {
    ...
    "data": {
      ...
      "nodeId": "codeNode",
      "values": {
        "code": "@scripts/embedded-chatbot-websites-indexation_extract-chunks.ts",
  ...
  },
  {
    ...
    "data": {
      ...
      "nodeId": "codeNode",
      "values": {
        "code": "@scripts/embedded-chatbot-websites-indexation_transform-metadata.ts",
