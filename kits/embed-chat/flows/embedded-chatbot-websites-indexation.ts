...
export const references = {
  ...
  "triggers": {
    "embedded_chatbot_websites_indexation_api_request": "@triggers/webhooks/embedded-chatbot-websites-indexation_api-request.ts"
  }
};
...
export const nodes = [
  {
    ...
    "data": {
      ...
      "values": {
        ...
        "responeType": "@triggers/webhooks/embedded-chatbot-websites-indexation_api-request.ts",
        "advance_schema": "@triggers/webhooks/embedded-chatbot-websites-indexation_api-request.ts"
      },
      "trigger": true
    },
    "type": "triggerNode",
