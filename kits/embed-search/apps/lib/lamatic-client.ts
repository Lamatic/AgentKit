...
if (!process.env.EMBEDDED_SEARCH_PDF_INDEXATION || !process.env.EMBEDDED_SEARCH_WEBSITES_INDEXATION || !process.env.EMBEDDED_SEARCH_SEARCH || !process.env.EMBEDDED_SEARCH_RESOURCE_DELETION) {
  throw new Error(
