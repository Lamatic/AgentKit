...
if (!process.env.EMBEDDED_CHATBOT_PDF_INDEXATION || !process.env.EMBEDDED_CHATBOT_WEBSITES_INDEXATION || !process.env.EMBEDDED_CHATBOT_CHATBOT || !process.env.EMBEDDED_CHATBOT_RESOURCE_DELETION) {
  throw new Error(
