    ...
    "flows": {
      "indexation": {
        "method1": {
          "name": "PDF Indexation",
          "type": "graphQL",
          "workflowId": process.env.EMBEDDED_SEARCH_PDF_INDEXATION,
        ...
        "method2": {
          ...
          "type": "graphQL",
          "workflowId": process.env.EMBEDDED_SEARCH_WEBSITES_INDEXATION,
        ...
        "rollback": {
            ...
            "workflowId": process.env.EMBEDDED_SEARCH_RESOURCE_DELETION,
      ...
      "search": {
        "name": "Search",
        "workflowId": process.env.EMBEDDED_SEARCH_SEARCH,
