...
3. Observe the evidence.
4. Perform targeted follow-up searches when necessary.
5. Stop when the important security questions have sufficient evidence.
...
- encryption and access-control claims
- subprocessors
- security incidents or breaches from reliable sources
- compliance claims
