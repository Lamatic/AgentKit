export default {
  ...
  steps: [
    { id: "fabric-material-analyzer", type: "kit" as const, envKey: "FABLENS_WORKFLOW_ID" }
  ],
  links: {
    github: "https://github.com/yashasvij-19/AgentKit/tree/new-main/kits/fablens",
    deploy:"https://vercel.com/new/clone?kits/fablens/apps"
  }
};