  ...
  },
  {
    ...
    "data": {
      ...
      "values": {
        ...
        "schema": "{\n  \"type\": \"object\",\n  \"properties\": {\n    \"jurisdiction\": {\n      \"type\": \"string\",\n      \"required\": true,\n      \"enum\": [\n        \"EU-261\",\n        \"UK-261\",\n        \"unknown\",\n        \"out-of-scope\"\n      ]\n    },\n    \"airline\": {\n      \"type\": \"string\"\n    },\n    \"flightNumber\": {\n      \"type\": \"string\"\n    },\n    \"originAirport\": {\n      \"type\": \"string\"\n    },\n    \"destinationAirport\": {\n      \"type\": \"string\"\n    },\n    \"scheduledDepartureDate\": {\n      \"type\": \"string\",\n      \"description\": \"YYYY-MM-DD, or empty string if not stated\"\n    },\n    \"disruptionType\": {\n      \"type\": \"string\",\n      \"required\": true,\n      \"enum\": [\n        \"delay\",\n        \"cancellation\",\n        \"denied-boarding\",\n        \"downgrade\",\n        \"other\"\n      ]\n    },\n    \"arrivalDelayHours\": {\n      \"type\": \"number\",\n      \"description\": \"Hours of arrival delay at final destination; 0 if none, -1 if unknown\"\n    },\n    \"reroutedArrivalDelayHours\": {\n      \"type\": \"number\",\n      \"description\": \"Cancellations only: hours the re-routing arrived relative to the original scheduled arrival (negative = arrived earlier, positive = arrived later); -999 if no rerouting or unknown\"\n    },\n    \"reroutedDepartureOffsetHours\": {\n      \"type\": \"number\",\n      \"description\": \"Cancellations only: hours the re-routing departed relative to the original scheduled departure (negative = departed earlier, positive = departed later); -999 if no rerouting or unknown\"\n    },\n    \"cancellationNoticeDays\": {\n      \"type\": \"number\",\n      \"description\": \"Days between cancellation notice and scheduled departure; -1 if unknown\"\n    },\n    \"cause\": {\n      \"type\": \"string\",\n      \"required\": true,\n      \"enum\": [\n        \"airline-controllable\",\n        \"extraordinary\",\n        \"unknown\"\n      ]\n    },\n    \"causeText\": {\n      \"type\": \"string\"\n    },\n    \"distanceKmEstimate\": {\n      \"type\": \"number\",\n      \"description\": \"Great-circle km between origin and final destination\"\n    },\n    \"distanceTier\": {\n      \"type\": \"string\",\n      \"required\": true,\n      \"enum\": [\n        \"short\",\n        \"medium\",\n        \"long\",\n        \"unknown\"\n      ]\n    },\n    \"bookingReference\": {\n      \"type\": \"string\"\n    }\n  }\n}"
      }
    },
    "type": "dynamicNode",
    "measured": { "width": 218, "height": 95 },
