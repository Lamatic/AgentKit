      ...
      <div className="flex items-center justify-between max-w-6xl mx-auto">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="text-lg font-medium tracking-tight text-neutral-900">
            Lamatic <span className="text-neutral-400 font-light mx-1">/</span> <span className="font-serif italic text-neutral-700">GitHub Commit Agent</span>
          </span>
        </Link>
        <nav className="flex items-center gap-8">
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-neutral-400 hover:text-neutral-900 transition-colors duration-200 tracking-wide flex items-center gap-1.5"
          >
