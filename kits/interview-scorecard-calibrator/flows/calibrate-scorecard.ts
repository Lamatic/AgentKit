...
export const meta = {
  ...
  "description": "Synthesize multi-interviewer feedback into a calibrated hiring scorecard and decision brief.",
  "tags": [
    "hiring",
    "interview",
    "scorecard"
...
export const references = {
  ...
  "prompts": {
    "calibrate_scorecard_calibrate_system": "@prompts/calibrate-scorecard_calibrate_system.md",
    "calibrate_scorecard_calibrate_user": "@prompts/calibrate-scorecard_calibrate_user.md",
    "calibrate_scorecard_compose_system": "@prompts/calibrate-scorecard_compose_system.md",
    "calibrate_scorecard_compose_user": "@prompts/calibrate-scorecard_compose_user.md"
  },
  "modelConfigs": {
    "calibrate_scorecard_calibrate": "@model-configs/calibrate-scorecard_calibrate.ts",
    "calibrate_scorecard_compose": "@model-configs/calibrate-scorecard_compose.ts"
  },
  "scripts": {
    "calibrate_scorecard_normalize": "@scripts/calibrate-scorecard_normalize.ts"
  }
};
