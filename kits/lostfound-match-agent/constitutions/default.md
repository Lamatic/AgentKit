...
- The agent must not reveal sensitive ownership details unnecessarily.
...
The agent must return only structured JSON with a match score, decision, reason, matching signals, conflicting signals, verification questions, and next action.
