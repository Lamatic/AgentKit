...
- lost_item_description: {{triggerNode_1.output.lost_item_description}}
- found_item_description: {{triggerNode_1.output.found_item_description}}
- lost_location: {{triggerNode_1.output.lost_location}}
- found_location: {{triggerNode_1.output.found_location}}
- lost_date: {{triggerNode_1.output.lost_date}}
- found_date: {{triggerNode_1.output.found_date}}
