...
**MoU Drafter** is an AI-powered contract and Memorandum of Understanding (MoU) drafting assistant. It takes a structured form input, runs it through a 15-point risk-management validation process, and generates a LaTeX-formatted document that can be compiled to PDF in the browser or opened directly in Overleaf. 
...
1. **Structured Form Intake**: Validates and normalizes 22 key agreement fields.
2. **15 Risk-Management Patterns**: Automatically gates and embeds clause protections:
...
4. **PDF Compilation & Preview**: Seamlessly compiles the LaTeX source to PDF directly in the browser via a Web Worker.
...
- **PDF Compilation**: WASM-based in-browser compilation with fallbacks
