...
Respond with ONLY a single JSON object — no markdown, no code fences, no commentary — with exactly these keys:
{
  ...
  "counter_email": "the full counter-offer email text, with line breaks",
  "call_script": "the short phone script, with line breaks",
