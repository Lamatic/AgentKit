  ...
  "tests": [
    {
      ...
      "payload": {
        "image_url": "http://burpcollaborator.net/image.png"
      },
  ...
  "tests": [
    {
      ...
      "payload": {
        "title": "Report",
        "custom_html": "<img src='http://169.254.169.254/latest/meta-data/iam/security-credentials/' />"
      },
  ...
  "tests": [
    {
      ...
      "payload": {
        "target_url": "http://make-127.0.0.1-rebind.com"
      },
