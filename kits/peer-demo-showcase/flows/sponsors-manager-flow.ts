  ...
  },
  {
    ...
    "data": {
      ...
      "values": {
        ...
        "limit": "50",
        "query": "",
        "where": "{{triggerNode_1.output.action == 'update_sponsor' ? 'id = \'' + triggerNode_1.output.id + '\'' : ''}}",
        "action": "{{triggerNode_1.output.action == 'add_sponsor' ? 'insert' : triggerNode_1.output.action == 'insert' ? 'insert' : triggerNode_1.output.action == 'update_sponsor' ? 'update' : 'select'}}",
        "offset": "0",
        "columns": "*",
        "orderBy": "",
        "nodeName": "Tables",
