...
## Problem
A first-draft technical spec is usually missing something â€” edge cases, a non-goals section, a rollout plan. SpecForge automates the first draft *and* a review pass, so what you get back has already been checked against a quality rubric.
