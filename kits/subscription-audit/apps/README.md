# Subscription Audit Kit by Lamatic.ai

<p align="center">
  <a href="https://agent-kit-subscription-audit.vercel.app" target="_blank">
    <img src="https://img.shields.io/badge/Live%20Demo-black?style=for-the-badge" alt="Live Demo" />
  </a>
</p>


**Subscription Audit Kit** is an AI-powered financial assistant built with [Lamatic.ai](https://lamatic.ai). It uses intelligent workflows to parse bank statements and extract recurring subscriptions, with an intuitive Next.js interface to review and audit your recurring charges.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Lamatic/AgentKit&root-directory=kits/subscription-audit/apps&env=SUBSCRIPTION_AUDIT,LAMATIC_API_URL,LAMATIC_PROJECT_ID,LAMATIC_API_KEY&envDescription=Your%20Lamatic%20Subscription%20Audit%20keys%20are%20required.&envLink=https://lamatic.ai/templates/agentkits/agentic/agent-kit-subscription-audit)
...
4. Select the 'Subscription Audit' agent kit
...
```bash
# Lamatic
SUBSCRIPTION_AUDIT = "SUBSCRIPTION_AUDIT Flow ID"
