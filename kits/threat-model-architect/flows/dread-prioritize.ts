...
export const nodes = [
  ...
  { id: "InstructorLLMNode_161", data: { label: "dynamicNode node", modes: {}, nodeId: "InstructorLLMNode", values: {
    id: "InstructorLLMNode_161", tools: [], schema: JSON.stringify({ type: "object", properties: { executive_risk_summary: { type: "string" }, ranked_threats: { type: "array", minItems: 1, items: { type: "object", additionalProperties: true } }, scoring_assumptions: { type: "array", items: { type: "string" } } }, required: ["executive_risk_summary", "ranked_threats", "scoring_assumptions"] }),
