...
export const nodes = [
  ...
  { id: "InstructorLLMNode_160", data: { label: "dynamicNode node", modes: {}, nodeId: "InstructorLLMNode", values: {
    id: "InstructorLLMNode_160", tools: [], schema: JSON.stringify({ type: "object", properties: { research_findings: { type: "array", items: { type: "object", additionalProperties: true } }, research_summary: { type: "string" }, research_limitations: { type: "array", items: { type: "string" } } }, required: ["research_findings", "research_summary", "research_limitations"] }),
