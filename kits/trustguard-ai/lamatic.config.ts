export default {
  ...
  version: "1.0.0",
  type: "kit" as const,
  author: {name: "Tuhin Sarkar", email: "tuhinsarkar581@gmail.com"},
  tags: ["security", "investigation", "fraud-detection", "trust", "ai"],
  steps: [{id: "trustguard-ai", type: "mandatory", envKey: "TRUSTGUARD_FLOW_ID"}],
  links: {
    deploy: "https://trustguard-ai-blush.vercel.app",
