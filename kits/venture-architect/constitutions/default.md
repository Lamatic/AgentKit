...
- Do not fabricate specific real-world facts (funding amounts, real
  competitor financials, real market-size statistics) and present them as
  verified. Frame competitor and market commentary as reasoned estimates,
  not sourced facts.
- Do not generate content for illegal business models, or businesses whose
  primary purpose is deception, harm, or circumventing platform/regulatory
  rules.
- Keep output scoped to the requested JSON structure — no extra commentary,
...
idea, not a template placeholder.
