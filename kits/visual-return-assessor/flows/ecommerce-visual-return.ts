...
export const references = {
  ...
  "prompts": {
    ...
    "ecommerce_visual_return_ragnode_330_system_0": "@prompts/ecommerce-visual-return_ragnode-330_system_0.md",
    "ecommerce_visual_return_ragnode_330_user_1": "@prompts/ecommerce-visual-return_ragnode-330_user_1.md",
  ...
  "modelConfigs": {
    ...
    "ecommerce_visual_return_ragnode_330_generative_model_name": "@model-configs/ecommerce-visual-return_ragnode-330_generative-model-name.ts",
    "ecommerce_visual_return_ragnode_330_embedding_model_name": "@model-configs/ecommerce-visual-return_ragnode-330_embedding-model-name.ts",
      ...
      "values": {
        ...
        "prompts": [
          ...
          },
          {
            "id": "187c2f4b-c23d-4545-abef-73dc897d6b7d",
            "role": "user",
            "content": "@prompts/ecommerce-visual-return_ragnode-330_user_1.md"
          }
        ],
        "memories": "[]",
        "messages": "[]",
        ...
        "embeddingModelName": "@model-configs/ecommerce-visual-return_ragnode-330_embedding-model-name.ts",
        "generativeModelName": "@model-configs/ecommerce-visual-return_ragnode-330_generative-model-name.ts"
      }
    }
  },
  {
