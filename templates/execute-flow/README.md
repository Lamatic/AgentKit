...
<a href="https://studio.lamatic.ai/_?templateSlug=execute-flow" target="_blank" style="text-decoration:none;">
  <div align="right">
...
This flow introduces the execute flow function, which allows executing another flow and passing required variables.
...
*Template ID: a69cd6e0-dc1d-4d1f-aaa3-d435e8399aa6*
